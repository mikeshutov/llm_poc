...
from agents.general.classify.prompts.classify_schema_prompt import CLASSIFY_SCHEMA
...
def build_classify_prompt(agent_state: AgentState) -> str:
    ...
    return (
        ...
        "Given the user's request, return only the category names that are relevant.\n\n"
