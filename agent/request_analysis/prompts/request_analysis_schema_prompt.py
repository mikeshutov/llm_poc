...
If the request is about storing, updating, recalling, or searching durable user-specific facts, preferences, constraints, or profile-like information, include "user_memories" in applicable_tool_categories.
