...
def namespace_evidence_id(agent_name: str, evidence_id: str) -> str:
    normalized_agent_name = agent_name.strip()
    normalized_evidence_id = evidence_id.strip()
    if not normalized_agent_name or not normalized_evidence_id:
        return normalized_evidence_id
    if normalized_evidence_id.startswith(f"{normalized_agent_name}:"):
        return normalized_evidence_id
    return f"{normalized_agent_name}:{normalized_evidence_id}"
